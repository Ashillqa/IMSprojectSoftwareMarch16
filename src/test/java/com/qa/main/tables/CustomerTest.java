...
public class CustomerTest {
		...
		@Before
		public void setUp() {
			customer = new Customer(1, "NC", "Pathak","07769975501");
			other = new Customer(1, "NC", "Pathak","07769975501");
		}
		...
		public void createCustomerWithId() {
			...
			assertEquals("Pathak", customer.getSurname());
		}
		...
		public void hashCodeTestWithNull() {
			...
			Customer other = new Customer(0, null,null,null);
			assertEquals(customer.hashCode(), other.hashCode());
		}
		
		@Test
		public void toStringTest() {
			String toString = "id: 1 first name: NC surname: Pathak";
